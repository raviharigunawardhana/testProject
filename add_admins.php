...
#country-list{float: left;list-style:none;margin-top:5px; margin-left:0%;padding:0;width:300px;position: absolute; border-radius:12px;}
...
<div class="x_panel">
                  <div class="x_title">
                    <h2>Assign Managers <small></small></h2>
...
//creating our table heading
        ...
        while ($row=$q -> fetch_assoc())
        {
            ...
            if($num_results23 == 0)
            {
                ...
                echo "<a href='index.php?tab=add_admin&&nic=$nic'><i class='fa fa-star-half-full'></i> Assign As Manager<span class='text-muted'></span><br> </a>";
            }
            else
            {
